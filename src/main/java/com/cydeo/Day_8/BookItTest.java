...
//create BookItUtil then create a method that accept e amil and password return token Bearer+yourToken as a String
...
@DisplayName("Get all capuses")
    @Test
    public void testAuth1(){
    // how to pass bearer token for bookıt? use header method to give as key value header
